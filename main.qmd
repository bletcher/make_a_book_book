...
Hit `Create repositry` to create the new repo.
...
<button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#exampleModal2">See in Full Screen</button>

<div class="modal fade" id="exampleModal2" tabindex="-1"><div class="modal-dialog modal-dialog-centered p-8" style="max-width: 90%"><div class="modal-content">
...
<button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#exampleModal3">See in Full Screen</button>

<div class="modal fade" id="exampleModal3" tabindex="-1"><div class="modal-dialog modal-dialog-centered p-8" style="max-width: 90%"><div class="modal-content">
...
<button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#exampleModal4">See in Full Screen</button>

<div class="modal fade" id="exampleModal4" tabindex="-1"><div class="modal-dialog modal-dialog-centered p-8" style="max-width: 90%"><div class="modal-content">
...
Return to your github page and hit the `Actions` tab. If all went well, you should see a green check icon followed by "pages build and deployment". If there is a green check and not a red x, we have created a web page
